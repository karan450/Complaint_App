...
export default function Login() {
    ...
    function handleChange(e){
        setInputs(oldinputs => ({...oldinputs,[e.target.name]:e.target.value}))
    }
    ...
    function onLogin(e){
        ...
        //changing login text to loading spiner
            ...
            if(inputs.username === ""){
                ...
                axios.post("http://localhost:80/api/login.php",inputs)
                .then(response => {
            ...
            <div className="l_screen">
                <div className="l_screen__content">
                    ...
                    <form className="l_login" onSubmit={onLogin}>
                        ...
                        <div className='l_newaccount' onClick={()=>navigate("/register")}>
                            <Link to="/register"
