...
export default function Electicity() {
  ...
  const handleSubmit = (event) => {
    ...
    axios.post("http://localhost:80/api/electricity.php", formData)
  ...
  return (
    ...
    <div className="trash_container">
      ...
      <div className="form-group">
        <label htmlFor="billnumber" className="firstLabel">Electicity Bill Number</label>
        <input 
            type="text" 
        ...
        <div className="form-group">
        <label htmlFor="usertime">When did the problem occur? (select date and time)</label>
            <input
                type="datetime-local"
                id="usertime"
